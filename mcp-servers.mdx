...
description: "Connect Claude Desktop, Cursor, Windsurf, and other AI agents to the Urantia Papers API and documentation via MCP. 19 tools, 2 resource templates, 2 prompts — zero setup."
---
