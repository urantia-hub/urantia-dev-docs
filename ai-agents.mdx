...
<Card title="MCP Servers" icon="plug" href="/mcp-servers">
  Connect AI agents to the Urantia Book via 2 MCP servers — 13 tools + 2 resources + 2 prompts on the API server, plus docs search. One-click install via Smithery.
</Card>
