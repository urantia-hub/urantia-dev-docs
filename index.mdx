...
<Columns cols={2}>
  ...
  <Card title="MCP Servers" icon="plug" href="/mcp-servers">
    Connect Claude, Cursor, or any AI agent — 13 tools, 2 resources, 2 prompts. One-click via Smithery.
  </Card>
...
- **MCP servers** at [`/mcp-servers`](/mcp-servers) — 13 tools + 2 resources + 2 prompts for Claude, Cursor, and other AI agents (one-click install via Smithery)
